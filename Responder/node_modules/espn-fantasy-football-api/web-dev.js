  ...
  homeRoster: {
    ...
    manualParse: function manualParse(responseData, data, constructorParams) {
      return lodash_map__WEBPACK_IMPORTED_MODULE_0___default()(responseData, function (playerData) {
        return _boxscore_player_boxscore_player__WEBPACK_IMPORTED_MODULE_2__["default"].buildFromServer(playerData, constructorParams);
      });
    }
  },
...
/* harmony import */ var _team_team__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../team/team */ "./src/team/team.js");
  ...
  _createClass(Client, [{
    ...
    value: function _buildAxiosConfig(config) {
      if (this.espnS2 && this.SWID) {
        ...
        return lodash_merge__WEBPACK_IMPORTED_MODULE_3___default()({}, config, {
          headers: headers,
    ...
    value: function getBoxscoreForWeek(_ref2) {
      ...
      var routeBase = "".concat(seasonId, "/segments/0/leagues/").concat(this.leagueId);
      ...
      return axios__WEBPACK_IMPORTED_MODULE_4___default.a.get(route, this._buildAxiosConfig()).then(function (response) {
        var schedule = lodash_get__WEBPACK_IMPORTED_MODULE_2___default()(response.data, 'schedule');

        var data = lodash_filter__WEBPACK_IMPORTED_MODULE_1___default()(schedule, {
          matchupPeriodId: matchupPeriodId
        });

        return lodash_map__WEBPACK_IMPORTED_MODULE_0___default()(data, function (matchup) {
    ...
    key: "getFreeAgents",
    value: function getFreeAgents(_ref3) {
      var _this2 = this;
      ...
      var route = "".concat(routeBase).concat(routeParams);
      return axios__WEBPACK_IMPORTED_MODULE_4___default.a.get(route, this._buildAxiosConfig()).then(function (response) {
        var data = lodash_get__WEBPACK_IMPORTED_MODULE_2___default()(response.data, 'players');

        return lodash_map__WEBPACK_IMPORTED_MODULE_0___default()(data, function (player) {
    ...
    key: "getTeamsAtWeek",
    value: function getTeamsAtWeek(_ref4) {
      var _this3 = this;
      ...
      var route = "".concat(routeBase).concat(routeParams);
      return axios__WEBPACK_IMPORTED_MODULE_4___default.a.get(route, this._buildAxiosConfig()).then(function (response) {
        var data = lodash_get__WEBPACK_IMPORTED_MODULE_2___default()(response.data, 'teams');

        return lodash_map__WEBPACK_IMPORTED_MODULE_0___default()(data, function (team) {
          return _team_team__WEBPACK_IMPORTED_MODULE_7__["default"].buildFromServer(team, {
